...
const IndexPage: FC<{}> = () => (
  <Layout>
    <SEO title="Home" />
    <div className="flex flex-col items-center justify-center max-w-md mx-auto my-7">
      <p>Hi, My name is Alan &#128075;</p>
      <br />
      <p>
        I&#39;m a software engineer who lives in Brooklyn, and I happen to be
        very interested in the topic of how our elections are funded.
      </p>
      <br />
      <p>
        This website contains curated lists of reference and educational
        material on the subject of campaign finance reform in a variety of
        different mediums.
      </p>
      <br />
      <p>
      ...
      <br />
      <p>
        Know of a great resource that I am missing? Have a burning question?
        Email me at{' '}
        <a
          className="underline"
